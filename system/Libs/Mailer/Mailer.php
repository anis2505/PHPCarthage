<?php
namespace System\Libs\Mailer;

use System\Libs\Mailer\Exceptions\MailerException;
...
class Mailer
{
	...
	public function send()
	{
		if (is_null($this->to))
		{
			throw new MailerException("Must have at least one recipient.");
		}
		
		if (is_null($this->from))
		{
			throw new MailerException("Must have one, and only one sender set.");
		}
		
		if (is_null($this->subject))
		{
			throw new MailerException("Subject is empty.");
		}
		
		if (is_null($this->textMessage))
		{
			throw new MailerException("Message is empty.");
		}
